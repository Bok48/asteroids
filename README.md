...
* Python 3.13
* uv 0.8.22, package and project manager
...
Use W and S to move forwards and backwards, while A and D is used to turn the spaceship.
Press **SPACEBAR** to fire projectiles to destroy the asteroids.

Destroy as many asteroids as you can, and get the highest score possible.